...
int main()
{
    ...
    try
    {
       std::cout << "Vulkan Compute Pipeline" << std::endl;
       vk::ApplicationInfo AppInfo{
        ...
        std::cout << "Vulkan Version " << VK_VERSION_MINOR(ApiVersion) << "." << VK_VERSION_MINOR(ApiVersion)<< "." << VK_VERSION_PATCH(ApiVersion) << std::endl;
